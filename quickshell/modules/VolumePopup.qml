    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            Rectangle {
                id: fgItem
                anchors.fill: parent
                anchors.rightMargin: Math.min(osdPanel.implicitWidth - svc.volumeValue * 3, 305)
                ...
                Text {
                    text: "󰽴"
                    color: svc.volumeValue < svc.threshold ? Colors.palette.base05 : Colors.palette.base06
                    font.pixelSize: 18
                    x: svc.volumeValue < svc.threshold ? osdPanel.implicitWidth - 50 : osdPanel.implicitWidth - 100
                    y: 5
                }
            }
            ...
            Rectangle {
                ...
                radius: 6
                x: Math.max(svc.volumeValue * 3 - 2, 5)
                y: 5
